...
const AsicsDetails = () => {
  return (
    <WorkDetails title={<StyledTitle>ASICS Digital</StyledTitle>}>
      <p>As a Senior Front-end Developer, made significant improvements to the architecture and UX of <a href="https://id.asics.com" style={{color: 'black', textDecoration: 'underline'}} target="_blank">id.asics.com</a>. Fluent in a cutting edge tech stack employed to make users’ lives easier.</p>
      <br />
